...
<?php echo $form->appendFormRows (
  ...
  Restful\Text::need ('密碼', 'password')->setAutofocus (true)->setMaxLength (255),
  Restful\Text::need ('確認密碼', 'password_check')->setAutofocus (true)->setMaxLength (255),
  Restful\Checkboxs::maybe ('角色權限', 'roles')->setItemKVs (AdminRole::$roleTexts)
);?>
