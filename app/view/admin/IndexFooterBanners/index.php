...
<?php echo $search->setTableClomuns (
  ...
  Restful\Column::create ('點擊次數')->setWidth (150)->setSort ('click_cnt')->setTd (function ($obj) { return '<a href="' . RestfulUrl::url ('admin/PvIndexFooterBanners@index', $obj) .'">' . number_format ($obj->click_cnt) . '</a>'; }),
