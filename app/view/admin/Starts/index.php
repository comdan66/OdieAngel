...
<?php echo $search->setTableClomuns (
  ...
  Restful\Column::create ('圖片')->setWidth (50)->setClass ('oaips')->setTd (function ($obj) { return $obj->pic->toImageTag ('wh710_400'); }),
  Restful\Column::create ('點擊次數')->setSort ('click_cnt')->setTd (function ($obj) { return '<a href="' . RestfulUrl::url ('admin/PvStarts@index', $obj) .'">' . number_format ($obj->click_cnt) . '</a>'; }),
