...
class IndexFooterBanners extends AdminRestfulController {

  public function __construct () {
    parent::__construct ();
    $this->layout->with ('title', '首頁下方輪播')
                 ->with ('current_url', RestfulUrl::url ('admin/IndexFooterBanners@index'));
  }
  ...
  public function index () {
    ...
    return $this->view->setPath ('admin/IndexFooterBanners/index.php')
  ...
  public function add () {
    return $this->view->setPath ('admin/IndexFooterBanners/add.php');
  }
  ...
  public function edit ($obj) {
    return $this->view->setPath ('admin/IndexFooterBanners/edit.php');
  }
