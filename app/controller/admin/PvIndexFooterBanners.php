...
class PvIndexFooterBanners extends AdminRestfulController {
  ...
  public function index () {
    $where = Where::create ('index_footer_banner_id = ?', $this->parent->id);
    ...
    $total = PvIndexFooterBanner::count ($where);
    $page  = Pagination::info ($total);
    $objs  = PvIndexFooterBanner::find ('all', array (
