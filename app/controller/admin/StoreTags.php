...
class StoreTags extends AdminRestfulController {

  public function __construct () {
    parent::__construct ();
    $this->layout->with ('title', '商家分類')
                 ->with ('current_url', RestfulUrl::url ('admin/StoreTags@index'));
  }
  ...
  public function index () {
    ...
    return $this->view->setPath ('admin/StoreTags/index.php')
  ...
  public function add () {
    return $this->view->setPath ('admin/StoreTags/add.php');
  }
  ...
  public function edit ($obj) {
    return $this->view->setPath ('admin/StoreTags/edit.php');
  }
